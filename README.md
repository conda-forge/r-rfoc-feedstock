...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4464&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-rfoc-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-rfoc` can be installed with `conda`:
...
```
mamba install r-rfoc
```

It is possible to list all of the versions of `r-rfoc` available on your platform with `conda`:
...
```
mamba search r-rfoc --channel conda-forge
```
...
mamba repoquery search r-rfoc --channel conda-forge

# List packages depending on `r-rfoc`:
mamba repoquery whoneeds r-rfoc --channel conda-forge

# List dependencies of `r-rfoc`:
mamba repoquery depends r-rfoc --channel conda-forge
```
